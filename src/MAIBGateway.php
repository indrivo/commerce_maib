...
class MAIBGateway {
  ...
  const MAIB_TEST_REDIRECT_URL = 'https://ecomm.maib.md:7443/ecomm2/ClientHandler';

  const MAIB_LIVE_REDIRECT_URL = 'https://ecomm.maib.md/ecomm2/ClientHandler';

  const MAIB_TEST_BASE_URI = 'https://ecomm.maib.md:4499';

  const MAIB_LIVE_BASE_URI = 'https://ecomm.maib.md:4455';
